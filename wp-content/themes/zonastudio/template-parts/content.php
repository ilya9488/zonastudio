...
<div class="col-md-4 col-6 px-md-10" <?php if (have_rows('fields')): while (have_rows("fields")) : the_row(); if( get_sub_field('project_photo') ): ?> data-toggle="modal" data-target="#modal_<?php echo get_the_ID(); ?>" data-whatever="@getbootstrap" <?php else: ?> title="Brak zdjęć projektu." data-photo="false" <?php endif; ?> <?php endwhile; else: ?> title="Brak zdjęć projektu." data-photo="false" <?php endif; ?>>
...
<?php if (have_rows('fields')): while (have_rows("fields")) : the_row(); $images = get_sub_field('project_photo'); if( $images ): ?>
	<div class="modal" id="modal_<?php echo get_the_ID(); ?>" tabindex="-1" aria-hidden="true">
